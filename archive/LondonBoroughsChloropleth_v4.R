...
map_change + 
  ...
  geom_text(data = borough_labels_excl_closed, aes(x = long, y = lat, label = id), size = 2) +
  geom_text(data = borough_labels_closed, aes(x = long, y = lat, label = id), colour = "red", size = 2)
