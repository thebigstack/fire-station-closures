...
# Choropleth of attendance time BEFORE closures -----------------------------------------------------
...
# Choropleth of attendance time AFTER closures ------------------------------------------------------
...
# Choropleth of attendance time diffs after closures ----------------------
...
timediff_map <- map_diff + 
                  ...
                  theme(
                    ...
                    legend.title = element_text(size=8, colour = "#4e4d47"),
                    legend.text = element_text(size=9, colour = "#4e4d47"),
...
poverty_map <- map_poverty + 
                ...
                theme(
                  ...
                  plot.subtitle = element_text(size=8, hjust=0.012, colour="#4e4d47", margin = margin(b=-0.1, t=0.41, l=2, unit="cm")),
                  plot.caption = element_text(size=7, colour="#4e4d47", margin=margin(b=0.3, r=-99, unit="cm") ),
                  legend.title = element_text(size=8, hjust=0.04, colour = "#4e4d47"),
                  legend.text = element_text(size=9, colour = "#4e4d47"),
                  legend.position = c(0.9, 0.09)
                ) +
...
ggsave("poverty_map.png", poverty_map, width=11, height=8.5)
